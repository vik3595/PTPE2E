		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PTP E2E",
									"targetURL": "#comleviptpe2e-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comleviptpe2e-display": {
								"semanticObject": "comleviptpe2e",
								"action": "display",
								"description": "An application for PTP E2E",
								"title": "PTP E2E",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.levi.ptpe2e",
									"url": sap.ui.require.toUrl("com/levi/ptpe2e")
								}
							}
						}
					}
